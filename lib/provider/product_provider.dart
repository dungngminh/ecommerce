...
class ProductProvider with ChangeNotifier {
  ...
  List<Product> productByCategory(String productCategory) => _products
  ...
  final List<Product> _products = [
    ...
    Product(
        ...
        price: 1100,
        imageSrc: 'https://m.media-amazon.com/images/I/71cSV-RTBSL.jpg',
        brand: 'Apple',
        productCategory: 'Phone & Gadgets',
        quantity: 3,
        isPopular: true),
    ...
    Product(
        ...
        description:
            'YAMAY Smart Watch 2020 Ver. Watches for Men Women Fitness Tracker Blood Pressure Monitor Blood Oxygen Meter Heart Rate Monitor IP68 Waterproof, Smartwatch Compatible with iPhone Samsung Android Phone & Gadgets',
        price: 183.99,
        imageSrc:
